...
fun AloneVpnTheme(
    ...
    // Called directly in each branch (not via a stored ::darkColorScheme / ::lightColorScheme
    // reference) — a callable reference to a function with default parameters loses those
    // defaults, which would force every other M3 role to be specified here too.
